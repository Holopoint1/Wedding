...
/* ---------- RSVP accept / decline celebration ----------
   Declines lights the frame red with an in-frame border runner + sparks.
   Accepts lights it green AND launches a full-page celebration: a comet
   travels once around the frame border shedding green sparks, while a
   shower of green sparks rains down across the whole page. */
let rsvpFxRun = 0;
